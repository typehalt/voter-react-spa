...
import FunctionalConstituencies from './Form/FunctionalConstituencies';
 ...
 */
class Reo41 extends React.Component {
  ...
  renderStepActions(step) {
    ...
    return (
      <div style={{margin: '12px 0'}}>
        <RaisedButton
          label={stepIndex === 6 ? '製作供上載的表格' : '下一步'}
          primary={true}
  ...
  render() {
    ...
    return (
      <div>
        <h1>現有選民，登記為功能組別選民</h1>
        <Stepper activeStep={stepIndex} orientation="vertical">
          <Step>
            <StepLabel>選擇功能組別</StepLabel>
            <StepContent>
              <p>
                首先，請選擇要登記的功能組別。
              </p>
